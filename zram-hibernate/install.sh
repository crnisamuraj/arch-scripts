...
echo ""
echo "Before running setup, add 'resume' after 'filesystems' in /etc/mkinitcpio.conf:"
echo ""
echo "  HOOKS=(base udev autodetect modconf kms keyboard keymap consolefont block filesystems resume fsck)"
echo ""
echo "Then run:"
